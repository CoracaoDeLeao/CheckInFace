...
class AplicativoCadastro:
    ...
    def centralizar_janela(self):
        # Definir tamanho fixo diretamente
        largura_janela = 350
        altura_janela = 450
    ...
    def criar_botoes(self):
        ...
        btn_fotos.grid(row=2, column=0, columnspan=2, padx=30, pady=5, sticky="ew")
        ...
        btn_salvar.grid(row=4, column=0, columnspan=2, padx=30, pady=5, sticky="ew")
    ...
    def salvar_cadastro(self):
        ...
        try:
            fotos = []
            for foto in self.fotos_selecionadas:
                fotos.append(image_to_base64(foto))
            
            saveFirestore(
                self.nome_entry.get().strip(), 
                self.ra_entry.get().strip(), 
                fotos
            )
